...
const permissionData = [
  ...
  ["project.view", "View projects"], ["project.create", "Create projects"], ["project.view_all", "View all company projects"], ["project.view_department", "View department projects"], ["project.view_assigned", "View assigned projects"], ["project.implementation.view", "View project implementation"], ["project.lifecycle.manage", "Manage project lifecycle"], ["project.deployment.view", "View deployments"], ["project.deployment.create", "Create deployments"], ["project.deployment.edit", "Edit deployments"], ["project.deployment.mark_active", "Mark deployments active"], ["project.edit", "Edit projects"], ["project.archive", "Archive projects"], ["project.manage_members", "Manage project members"], ["project.assign_tasks", "Assign project tasks"], ["project.manage_modules", "Manage project modules"], ["project.manage_milestones", "Manage project milestones"], ["project.view_activity", "View project activity"], ["project.upload_documents", "Upload project documents"], ["task.view", "View tasks"], ["task.create", "Create tasks"],
