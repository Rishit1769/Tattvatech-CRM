...
const permissionData = [
  ...
  ["project.view", "View projects"], ["project.create", "Create projects"], ["project.view_all", "View all company projects"], ["project.view_department", "View department projects"], ["project.view_assigned", "View assigned projects"], ["project.implementation.view", "View project implementation"], ["project.lifecycle.manage", "Manage project lifecycle"], ["project.development.manage", "Manage development details"], ["project.testing.manage", "Manage testing details"], ["project.payment_status.view", "View project payment status"], ["project.deployment.view", "View deployments"], ["project.deployment.create", "Create deployments"], ["project.deployment.edit", "Edit deployments"], ["project.deployment.mark_active", "Mark deployments active"], ["deployment.view", "View deployment records"], ["deployment.create", "Create deployment records"], ["deployment.manage", "Manage deployment records"], ["project.edit", "Edit projects"], ["project.archive", "Archive projects"], ["project.manage_members", "Manage project members"], ["project.assign_tasks", "Assign project tasks"], ["project.manage_modules", "Manage project modules"], ["project.manage_milestones", "Manage project milestones"], ["project.view_activity", "View project activity"], ["project.upload_documents", "Upload project documents"], ["task.view", "View tasks"], ["task.create", "Create tasks"],
  ["finance.view", "View finance"], ["finance.transaction.view", "View transactions"], ["finance.transaction.create", "Create transactions"], ["finance.payment.confirm", "Confirm received payments"], ["finance.transaction.attach_document", "Attach transaction documents"], ["finance.invoice.view", "View invoices"], ["finance.invoice.create", "Create invoices"], ["finance.invoice.generate", "Generate invoices"], ["finance.invoice.download", "Download invoices"], ["finance.invoice.send", "Send invoices"], ["finance.quotation.view", "View quotations"], ["finance.quotation.create", "Create quotations"], ["finance.quotation.edit", "Edit quotations"], ["finance.quotation.finalize", "Finalize quotations"], ["finance.quotation.download", "Download quotations"], ["finance.quotation.send", "Send quotations"],
  ...
  ["project.assign_members", "Assign project members"], ["finance.project.create", "Create projects from Finance"], ["finance.project.view_commercial", "View project commercial details"],
];
...
const orgPermissions = {
  CEO: ["dashboard.view", "project.view_all", "project.implementation.view", "project.deployment.view", "project.view_activity", "team.view", "finance.view", "finance.quotation.view", "finance.quotation.create", "lead.view", "client.view", "activity.view"],
  CTO: ["dashboard.view", "project.view_all", "project.implementation.view", "project.lifecycle.manage", "project.development.manage", "project.testing.manage", "project.payment_status.view", "project.deployment.view", "project.deployment.create", "project.deployment.edit", "project.deployment.mark_active", "deployment.view", "deployment.create", "deployment.manage", "project.edit", "project.manage_members", "project.assign_members", "project.assign_tasks", "project.manage_modules", "project.view_activity", "task.view", "task.create", "infrastructure.view"],
  CFO: ["dashboard.view", "project.view_all", "project.payment_status.view", "finance.view", "finance.project.create", "finance.project.view_commercial", "finance.transaction.view", "finance.transaction.create", "finance.payment.confirm", "finance.transaction.attach_document", "finance.invoice.view", "finance.invoice.create", "finance.invoice.generate", "finance.invoice.download", "finance.invoice.send", "finance.quotation.view", "finance.quotation.create", "finance.quotation.edit", "finance.quotation.finalize", "finance.quotation.download", "finance.quotation.send", "activity.view"],
