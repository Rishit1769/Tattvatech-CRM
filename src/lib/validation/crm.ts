...
export const financeProjectCreateSchema = projectCreateSchema.extend({ expectedPaymentAmount: z.coerce.number().min(0).optional(), paymentDueDate: z.string().optional(), commercialNotes: z.string().max(5000).optional(), amcApplicable: z.boolean().optional(), amcAmount: z.coerce.number().min(0).optional(), amcFrequency: z.string().max(40).optional() });
