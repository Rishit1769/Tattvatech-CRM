...
- Local/dev environment configuration for MySQL and SMTP. MinIO integration is intentionally deferred per the current implementation scope.
...
- MySQL connectivity works locally; storage remains explicitly marked as deferred until the MinIO phase is implemented.
